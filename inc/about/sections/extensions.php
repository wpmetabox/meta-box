...
<div id="extensions" class="gt-tab-pane">
	<p class="about-description">
		...
		<?php esc_html_e( 'Save over 70% with our extensions bundles.', 'meta-box' ); ?> <a target="_blank" href="https://metabox.io/pricing/?utm_source=WordPress&utm_medium=link&utm_campaign=plugin"><?php esc_html_e( 'View Bundles', 'meta-box' ); ?> &rarr;</a></p>
