...
class RWMB_OSM_Field extends RWMB_Field {
	...
	private static function enqueue_map_assets() {
		...
		wp_style_add_data( 'leaflet', 'path', RWMB_JS_DIR . 'leaflet/leaflet.css' );
		...
		wp_style_add_data( 'leaflet-gesture-handling', 'path', RWMB_JS_DIR . 'leaflet/leaflet-gesture-handling.min.css' );
