...
if ( ! class_exists( 'RWMB_Time_Field' ) ) 
{
	class RWMB_Time_Field 
	{
		...
		static function admin_print_styles( ) 
		{
			...
			wp_enqueue_script( 'rwmb-time', RWMB_JS_URL.'time.js', array( 'jquery', 'jquery-ui-timepicker' ), RWMB_VER, true );
		}
		...
		static function html( $html, $meta, $field ) 
		{
			...
			$val   = " value='{$meta}'";
			$html .= "<input type='text' class='rwmb-time rwmb-input' size='30'{$name}{$id}{$rel}{$val} />";
