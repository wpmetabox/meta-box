...
if ( ! class_exists( 'RWMB_Color_Field' ) )
{
	class RWMB_Color_Field
	{
		...
		{
			wp_enqueue_style( 'rwmb-color', RWMB_CSS_URL . 'color.css', array( 'iris', 'farbtastic',  'wp-color-picker' ), RWMB_VER );
			wp_enqueue_script( 'rwmb-color', RWMB_JS_URL . 'color.js', array( 'iris', 'farbtastic',  'wp-color-picker' ), RWMB_VER, true );
		}
