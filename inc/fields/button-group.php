...
class RWMB_Button_Group_Field extends RWMB_Choice_Field {
	...
	public static function admin_enqueue_scripts() {
		wp_enqueue_style( 'rwmb-button-group-list', RWMB_CSS_URL . 'button-group.css', '', RWMB_VER );
		wp_enqueue_script( 'rwmb-button-group-list', RWMB_JS_URL . 'button-group.js', array(), RWMB_VER, true );
	}
