		...
		function show( ) 
		{
			...
			foreach ( $this->fields as $field ) 
			{
                ...
                $class .= add_cssclass( @$field['class'], $class );
           		echo "<div class='{$class}'>{$html}</div>"; // AGM!!! Change TABLE to DIV
			}
...
HTML;
		...
		**************************************************/
		 ...
		 * @since	
		 * @param	(array) 		$meta_box	| Meta box definition
		 * @return	(unknown_type)	$meta_box	| Normalized meta box
		 */
		 ...
		 * @return	(mixed)		(string) $class OR (boolean) false | Field class name OR false on failure
		 */
