...
<div class="mb-dashboard__main">
	<header class="mb-dashboard__header">
		<img src="<?php echo esc_attr( $this->assets_url ) ?>/meta-box.svg" alt="Meta Box" />
	</header>
	...
	<div class="mb-dashboard__widget mb-dashboard__widget--upgrade">
		...
		<div class="mb-dashboard__widget-body">
			<ul>
				...
				<li><svg><use xlink:href="#check-circle"></use></svg><?php esc_html_e( 'Save field data to custom tables.', 'meta-box' ); ?></li>
			...
			<a class="mb-dashboard__button" target="_blank" href="https://metabox.io/pricing/?utm_source=dashboard&utm_medium=link&utm_campaign=meta_box"><?php esc_html_e( 'Get Meta Box AIO', 'meta-box' ); ?></a>
		</div>
	</div>
